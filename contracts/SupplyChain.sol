...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  /* Add a keyword so the function can be paid. This function should transfer money
    ...
    //forSale(items[sku].sku) paidEnough(items[sku].price) checkValue(items[sku].sku) 

  function buyItem(uint sku)
    public payable forSale(items[sku].sku) paidEnough(items[sku].price) checkValue(items[sku].sku)
  {
  ...
  function shipItem(uint sku)
    public sold(items[sku].sku) verifyCaller(items[sku].seller)
  {
  ...
  function receiveItem(uint sku)
   public shipped(items[sku].sku) verifyCaller(items[sku].buyer) 
  {
